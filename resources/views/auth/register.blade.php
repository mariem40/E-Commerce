    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
				          ...
				          <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="number" class="form-control @error('tel') is-invalid @enderror" name="tel" value="{{ old('prenom') }}" required autocomplete="tel" >
			 ...
			 <div class="col-md-6">
			<input class="form-control @error('age') is-invalid @enderror" type="number" id="age" name="age" value="" placeholder="age d'admin">
